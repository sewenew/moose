...
{
  return MooseEnum("CONSTANT FIRST SECOND THIRD FOURTH FIFTH SIXTH SEVENTH EIGHTH NINTH TENTH ELEVENTH TWELFTH THIRTEENTH FOURTEENTH FIFTEENTH", "FIRST", true);
}
...
AddAuxVariableAction::act()
{
  if (_current_task == "add_aux_variable")
  {
    ...
    else
    {
      ...
      if (_fe_type.order > 15)
        mooseError("Non-scalar AuxVariables must be CONSTANT, FIRST, SECOND, THIRD, FOURTH, FIFTH, SIXTH, SEVENTH, EIGHTH, NINTH, ELEVENTH TWELFTH, THIRTEENTH, FOURTEENTH, or FIFTEENTH order (" << _fe_type.order << " supplied)");
